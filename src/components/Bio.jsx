	...
	return (
		<div className="mb-4">
			...
			<p className="font-body mt-8">
				My name is Alex Staples and I am cool and no one is better than me at
				smashing my face on the keyboard. I am from Stockhold, Sveeeeden and I
				like to play the clarinet from my Moai.
			</p>
		</div>
	);
}
